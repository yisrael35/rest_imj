...
CREATE TABLE IF NOT EXISTS `imj_db`.`bid` (
  ...
  INDEX `fk_bid_location1_idx` (`location_id` ASC)  ,
  INDEX `fk_bid_event_type1_idx` (`event_type_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `imj_db`.`cost` (
  ...
  `comment` VARCHAR(200) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_costs_bid1_idx` (`bid_id` ASC)  ,
  INDEX `fk_costs_event1_idx` (`event_id` ASC)  ,
...
CREATE TABLE IF NOT EXISTS `imj_db`.`schedule_event` (
  ...
  `description` VARCHAR(200) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_schedule_event_event1_idx` (`event_id` ASC)  ,
  INDEX `fk_schedule_event_bid1_idx` (`bid_id` ASC)  ,
